...
import cn.jd.shop.realtime.etl.utils.pool.{ConnectionPoolConfig, HbaseConnectionPool}
...
object HbaseUtil {
  ...
  hbaseConfig.set("hbase.zookeeper.quorum",GlobalConfigUtil.`zookeeper.connect`)
